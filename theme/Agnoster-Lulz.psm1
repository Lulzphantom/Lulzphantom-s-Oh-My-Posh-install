...
function Write-Theme {
    ...
    $user = ' ' + $sl.PromptSymbols.UserSymbol + $displayUser
    $computer = $sl.CurrentHostname
    if (Test-NotDefaultUser($user)) {
        $prompt += Write-Prompt -Object "$user " -ForegroundColor $sl.Colors.GitForegroundColor -BackgroundColor $sl.Colors.VirtualEnvBackgroundColor
    }
...
$sl.PromptSymbols.PromptIndicator = [char]::ConvertFromUtf32(0xE0B1)
$sl.PromptSymbols.SegmentForwardSymbol = [char]::ConvertFromUtf32(0xE0C0)
$sl.PromptSymbols.UserSymbol = [char]::ConvertFromUtf32(0xE0CC)
